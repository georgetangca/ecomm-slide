...
function startGA()
{
pageTracker = _gat._getTracker("UA-300475-7");
pageTracker._initData();
pageTracker._trackPageview();

pageTracker2 = _gat._getTracker("UA-300475-35");
...
<script type="text/javascript">
// <![CDATA[
document.write("<img id='img1' height='1' width='1' src='' alt='' />");
...
<script src="http://mint.canadianfamily.ca/?js" type="text/javascript"></script> 
<!---->
...
<body id="ecomm_slideshow">
   <input type="hidden" value="" id="slide_parent_postid"/>
   <input type="hidden" value="" id="slide_parent_slug"/>
   <input type="hidden" value="" id="slide_count_per_page"/>
   <input type="hidden" value="" id="slide_total_count"/>
   <input type="hidden" value="" id="slide_last_page"/>
   <input type="hidden" value="" id="active_slide_index"/>
   ...
   <div id="slide_page"  class="slide_default_page"><!--start #page-->
    ...
    <!--SKIM LINKS-->
    <script type="text/javascript" src="http://s.skimresources.com/js/130X979131.skimlinks.js"></script>
</body>    
</html>
<?php 
ob_flush();
