...
if ( !class_exists('ecomm_custom_taxonomy') ) {
	
	class ecomm_custom_taxonomy{
		...
		function register_taxonomy(){
			...
			$defaults = array('labels' => array('name' => $this->plural,
                                                    ...
                                                    'popular_items' => __('Popular ', 'stjoseph_ecomm').$this->plural,
                                                    'all_items' => __('All ', 'stjoseph_ecomm').$this->plural,
                                                    'parent_item' => __('Parent ', 'stjoseph_ecomm').$this->singular,
                                                    'parent_item_colon' => sprintf( __('Parent %s:', 'stjoseph_ecomm'), $this->singular ),
                                                    'edit_item' => __('Edit ', 'stjoseph_ecomm').$this->singular,
                                                    'update_item' => __('Update ', 'stjoseph_ecomm').$this->singular,
                                                    'add_new_item' => __('Add New ', 'stjoseph_ecomm').$this->singular,
                                                    'new_item_name' => sprintf( __('New %s Name', 'stjoseph_ecomm'), $this->singular ),
                                                    'separate_items_with_commas' => sprintf( __('Separate %s with commas', 'stjoseph_ecomm'), $this->plural),
                                                    'add_or_remove_items' => __('Add or remove ', 'stjoseph_ecomm').$this->plural,
                                                    'choose_from_most_used' => __('Choose from the most used ', 'stjoseph_ecomm').$this->plural),
